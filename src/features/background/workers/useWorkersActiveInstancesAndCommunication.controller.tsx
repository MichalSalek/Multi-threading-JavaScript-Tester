...
} from '@/features/background/workers/workers.api'
import {
    IWorkerDTO,
    IWorkerKey,
    WorkerKeyType,
...
import {IWorkersSlice, selectRequestedWorkersAmount} from '@/features/background/workers/workers.slice'
import {WEB_WORKER_TASKS} from '@/features/background/workers/workersEvents'
import {selectSocketIsActive} from '@/features/background/socket-client/socket.slice'
...
const useWorkersActiveInstancesAndCommunicationController = (): void => {
    ...
    // Requested from building, a number of workers
    //

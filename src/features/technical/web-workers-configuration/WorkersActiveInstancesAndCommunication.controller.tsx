...
import { selectSocketIsActive } from '@/features/technical/socket-client/socketSlice'
...
import { sendTriggerMessageToSocket } from '@/features/technical/socket-client/socket.api'

...
import {
    ...
    queueWorkerTask
} from '@/features/technical/web-workers-configuration/webWorkers.api'
import { WEB_WORKER_TASKS } from '@/features/technical/web-workers-configuration/webWorkersEvents'
import { WorkerKeyType } from '@/features/technical/web-workers-configuration/webWorkers.types'
import {
    useSingleWorkerSpecificStatus,
    UseSpecificWorkerStatusCommandEnum
} from '@/features/technical/calculation-workers-configuration/calculationWorkers.hooks'
...
import { useMainThreadCalculations } from '@/features/business/calculation-workers-controls/calculationWorkersControls.hooks'
...
const CalculationWorkersWorkSwitchMolecule = ({workerKey, globalComplexityValue}: IProps): JSX.Element => {
